...
<%-- <div id=header class="container-fluid">
	<h1 id="siteTitle">playdatenow_v03</h1>
	...
	<div id="navContainer" class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarsExample02">
			<ul class="navbar-nav me-auto">
				<li class="nav-item"><h1 class="text-white">springsecurityapi_v06</h1></li>
			...
			<c:if test="${currentUser.id != null}"> 
				<div id="dropDownStuff" class="dropdown text-end">
					...
					<ul class="dropdown-menu text-small">
						...
						<li><hr class="dropdown-divider"></li>
						<li>
							<!-- <a class="dropdown-item text-dark" href="/logout">Sign out</a> -->
				...
				</div> <!-- end dropDownStuff -->
			</c:if>
			
		</div> <!-- end navbarsExample02 -->
