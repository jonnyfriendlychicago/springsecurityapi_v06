					...
					<div class="d-flex justify-content-between">
						<div class="card p-2 border-0">
							<p class="m-0 text-secondary" style="font-size: 0.8rem;">
								...
								<fmt:formatDate value="${currentUser.createdAt}" pattern="EEEE"/>,
								<fmt:formatDate value="${currentUser.createdAt}" pattern="MMMM dd"/>
								, 
								<fmt:formatDate value="${currentUser.createdAt}" pattern="yyyy"/>, 
								<fmt:formatDate value="${currentUser.createdAt}" pattern="h:mm a"/>
...
<%-- 					<div class="card p-2 border-0">
					...
					<div class="card p-2 border-0">
						...
						<p class="m-0">${currentUser.firstName}</p>
					</div>
					
					<div class="card p-2 border-0">
						<p class="m-0 text-secondary" style="font-size: 0.8rem;">Last name</p>
						<p class="m-0">${currentUser.lastName}</p>
					</div>
					<div class="card p-2 border-0">
